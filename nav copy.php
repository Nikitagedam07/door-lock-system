...
<div id="ngdiv">
	<div id="ngdivparts">
		...
		<img src="images/logo_door.jpg" alt="doora logo 1">
	</div>
	...
	<div class="ngdivpart" id="ngdivpart3">
		<img src="images/SAKEC.png" alt="doora logo 2">
	</div>
 ...
 <div id="ngnav">
        ...
        <nav>
            <ul>
                <li><a href="display.php" title="">Users</a></li>
        ...
        if (isset($_SESSION['Admin-name'])) {
            echo '<li><a href="#" data-toggle="modal" data-target="#admin-account">'.$_SESSION['Admin-name'].'</a></li>';

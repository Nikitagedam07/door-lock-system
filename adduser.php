...
<h1>add user </h1>
<a href="adduser.php"><button type="submit" name="submit" id="submit">add_user </button></a>
  <a href="updateuser.php"><button type="submit" name="submit" id="submit">update_user </button></a>
  <a href="deleteuser.php"><button type="submit" name="submit" id="submit">delete_user </button></a>
...
<div class="aling:center">
  <div class="form">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Insert data into original_records table
        $sql = "INSERT INTO original_records (name, rfid, email) VALUES ('$name', '$rfid', '$email')";
